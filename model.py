...
def main():
    ...
    trainer = spacy.load("./spaCyModels/trained_test_model") # load the trained model
    ...
    # Test the trained model
    print("Testing model...")
    text = "Schedule a meeting to learn how to cook pasta on Friday, April 26th at 7pm."
    doc = trainer(text)
    for ent in doc.ents:
        print(ent.text, ent.label_)
